...
public class TestCalculadora {
	...
	public static void main(String[] args) {
		...
		do {
			...
			System.out.println("6 - Número positivo o negativo");
			...
			System.out.println("12 - Contar los divisores de un número");
	...
	public static void sumatoriaV2(Calculadora celular, Scanner teclado) {
		...
		System.out.println(
				"La sumatoria entre estos dos limites es: " + celular.sumatoriaV2(limiteInferior, limiteSuperior));
	}

	public static void productoria(Calculadora celular, Scanner teclado) {
		int limite = 0;
		System.out.println("Ingrese el limite para multiplicar los valores menores a él");
		limite = teclado.nextInt();
	...
	public static void productoriaV2(Calculadora celular, Scanner teclado) {
		...
		System.out.println(
				"La productoria entre estos dos limites es: " + celular.productoriaV2(limiteInferior, limiteSuperior));
	}
